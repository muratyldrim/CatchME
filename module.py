...
def connect_elasticsearch(logger):
    ...
    while conn_check == "False":
        es = Elasticsearch([{'host': 'xx.xx.xx.xxx', 'port': '9200'}])
        if es.ping():
...
class DatabaseOps:
    ...
    def delete_mysql(logger):
        ...
        mysql_esy = pymysql.connect(host='xx.xx.xx.xxx',
                                    user='xxxx',
                                    password='xxxxx',
                                    db='unixdb',
                                    charset='utf8mb4')
        ...
        mysql_gzm = pymysql.connect(host='xxx.xx.xx.xx',
                                    user='xxxxxxxx',
                                    password='xxxxxxx',
                                    db='unixdb',
                                    charset='utf8mb4')
    ...
    def insert_mysql(host, feature, score, logger):
        ...
        '''esenyurt db operations'''
        mysql_esy = pymysql.connect(host='xxxxxxx',
                                    user='xxxxx',
                                    password='xxxxxx',
                                    db='unixdb',
                                    charset='utf8mb4')
